...
drop table tbl_board_type if exists
drop table tbl_chart if exists
CREATE TABLE tbl_chart(red INTEGER DEFAULT 0, blue INTEGER DEFAULT 0, yellow INTEGER DEFAULT 0, green INTEGER DEFAULT 0, purple INTEGER DEFAULT 0, orange INTEGER DEFAULT 0)
INSERT INTO tbl_chart(red, blue, yellow, green, purple, orange) VALUES(0,0,0,0,0,0)
...
UPDATE tbl_board SET board_type = 'gallery' WHERE bno > 5
