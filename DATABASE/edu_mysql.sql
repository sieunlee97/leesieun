...
CREATE TABLE `tbl_member` (
  ...
  `levels` varchar(45) DEFAULT 'ROLE_USER' COMMENT '권한, 회원등급 2가지, ROLL_ADMIN(관리자), ROLL_USER(사용자)\n',
  `reg_date` timestamp NULL DEFAULT current_timestamp() COMMENT '등록일시\n\n',
  `update_date` timestamp NULL DEFAULT current_timestamp() COMMENT '수정일시\n\n',
  PRIMARY KEY (`user_id`)
...
-- Dump completed on 2020-12-23 14:52:29
